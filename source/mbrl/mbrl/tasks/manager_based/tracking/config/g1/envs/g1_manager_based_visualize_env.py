...
from mbrl.tasks.manager_based.tracking.config.g1.envs.g1_manager_based_mbrl_env import G1ManagerBasedMBRLEnv


class G1ManagerBasedVisualizeEnv(ManagerBasedVisualizeEnv, G1ManagerBasedMBRLEnv):
    """Visualize imagined tracking rollouts against real simulation."""
